...
class OpenRouterAgent:
  ...
  def _build_system_prompt() -> str:
    return (
      ...
      "Prioritize metrics interpretation (likes, comments, saves, views, engagement, publish time, followers, stories, follower quality, trial-vs-main reel behavior). "
      ...
      "If the user asks about trial reels, trial mode, or test reels, use get_profile_reels with mode='trial'. "
      "If the user asks about main reels, use get_profile_reels with mode='main'. "
